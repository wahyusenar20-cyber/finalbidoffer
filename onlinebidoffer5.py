...
# ==========================================
# CSS UI/UX MODERN & COMPACT (TEMA PRO-TERMINAL)
# ==========================================
st.markdown("""
    <style>
        /* Mengambil font modern untuk UI dan monospace untuk angka */
        ...
        /* 1. CLEAN UI: Menyembunyikan elemen bawaan Streamlit yang memakan tempat */
        #MainMenu {visibility: hidden;}
        footer {visibility: hidden;}
        [data-testid="stStatusWidget"] {visibility: hidden;}
        /* Header tidak disembunyikan agar tombol panah sidebar tetap bisa di-klik */
        
        /* 2. ANTI-FREEZE & COMPACT LAYOUT */
        ...
        /* 3. DESAIN TABEL MODERN (PADAT & RAPI UNTUK HP/TABLET) */
        ...
        table.dataframe {
            ...
            text-align: left;
            font-size: 0.85rem; /* Ukuran compact */
            font-family: 'JetBrains Mono', monospace; /* Kesan terminal profesional */
        ...
        /* Efek nyala saat baris ditunjuk/disentuh */
        table.dataframe tr:hover td {
            background-color: #2b2d31; 
        }

        /* 4. CUSTOM SCROLLBAR MINIMALIS */
...
def render_tabel_avg(data_list, rank_history):
    ...
    for i, item in enumerate(data_list):
        ...
        rows.append({
            ...
            "Ticker & Chg": ticker_cell, 
            "Harga (B-O)": price_cell, 
            "Avg Lot (B|O)": l_str, 
            "Avg Freq (B|O)": f_str, 
...
def style_dataframe(df):
    # Menggunakan output HTML murni agar class CSS khusus kita bekerja dengan sempurna
