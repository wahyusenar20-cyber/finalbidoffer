...
# ==========================================
# CSS UI/UX MODERN & ULTRA COMPACT (FIT UNTUK HP & DESKTOP)
# ==========================================
st.markdown("""
    <style>
        ...
        .modern-table-wrapper {
            ...
            /* Membuat wadah tabel menyesuaikan isi, bukan layar */
            width: fit-content; 
            max-width: 100%;
        }
        
        table.dataframe {
            /* width: 100%; <-- Dihapus agar tidak melar di mode desktop */
            width: max-content; 
        ...
        table.dataframe th {
            ...
            color: #a0a0a0;
            font-weight: 600;
            padding: 6px 6px; /* Padding extra tipis */
        ...
        table.dataframe td {
            padding: 4px 6px; /* Padding extra tipis */
...
# ==========================================
# 4. RENDERING & STYLING (VERSI REORDER & RESIZE HARGA)
# ==========================================
def render_tabel_avg(data_list, rank_history):
    ...
    for i, item in enumerate(data_list):
        ...
        # Harga diperkecil ukurannya jadi 0.75em agar tidak memakan fokus
        ...
        # Urutan kolom ditukar guling: No, Saham, Lot, Freq, Harga, Skor
        rows.append({
